...
class SaleOrder(models.Model):
    ...
    # model for sale order status Start
    sales_order_stage = fields.Text(string='Sales Order Stage')

    po_date = fields.Date(string='PO Date')
    transportation_method = fields.Selection([
        ('by_air', 'By Air'),
        ('by_ship', 'By Ship')],
        string='Transportation Methods'
    )


    # model for sale order status End
    ...
    #Fields of Quotatiobn form added here
